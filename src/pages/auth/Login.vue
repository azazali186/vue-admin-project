      ...
      <div class="card fusion-cosmic">
        <div class="card-header">
          <div class="header-containt">
            <span class="left-login-color right-line-color">{{ $t(Utils.getKey('Welcome')) }}</span
            ><span class="left-login-color">{{ $t(Utils.getKey('login')) }}</span>
          </div>
        </div>
        <div class="card-body">
          <InputBox
...
onMounted(async () => {
  ...
  console.log("lanfuages value is ", languages.value)
  });
</script>
